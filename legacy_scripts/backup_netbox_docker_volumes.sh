#/bin/sh 
# Script to create a ziped dump of netbox-volumes, Idea taken from https://www.laub-home.de/wiki/Docker_Backup_und_Restore_-_eine_kleine_Anleitung
...
docker run --rm \
        ...
        -v /home/ad005.onehc.net/z004mc4v-a01/dev_tools_in_production/netbox-docker/data/backup:/backup \
